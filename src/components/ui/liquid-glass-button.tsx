  ...
  return (
    <>
      ...
      >
        <div
          className={cn(
            'absolute top-0 left-0 z-0 h-full w-full rounded-md transition-all',
...
/** SVG filter for liquid glass effect. Render once per page (e.g. in dock or layout). */
...
/** Tailwind-compatible class for the liquid glass inset shadow (light mode). */
export const liquidGlassShadowClass =
  'shadow-[0_0_6px_rgba(0,0,0,0.03),0_2px_6px_rgba(0,0,0,0.08),inset_3px_3px_0.5px_-3px_rgba(0,0,0,0.9),inset_-3px_-3px_0.5px_-3px_rgba(0,0,0,0.85),inset_1px_1px_1px_-0.5px_rgba(0,0,0,0.6),inset_-1px_-1px_1px_-0.5px_rgba(0,0,0,0.6),inset_0_0_6px_6px_rgba(0,0,0,0.12),inset_0_0_2px_2px_rgba(0,0,0,0.06),0_0_12px_rgba(255,255,255,0.15)]';

/** Tailwind-compatible class for the liquid glass inset shadow (dark mode). */
export const liquidGlassShadowDarkClass =
